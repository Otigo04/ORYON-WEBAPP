...
name: TAS Webworks All-in-One
description: "Use when building, extending, or reviewing the TAS Webworks agency web app. Tech: Next.js (App Router), TypeScript, Tailwind, Shadcn UI, Supabase Auth & PostgreSQL. Keywords: Portfolio, Preisrechner, Lead-Generierung, Kunden-Dashboard, Server Actions, Zod."
...
Das ZIEL ist es, TAS Webworks als Web Agentur richtig gut zu präsentieren, weil potentielle Kunden unsere Firma buchen können durch die Seite.
