...
Die aktuellen Dateien sind **Platzhalter** im OTIGO-Stil – einfach mit denselben
Dateinamen überschreiben, dann erscheint dein echtes Logo automatisch überall.

| Datei                | Verwendung                                  |
| -------------------- | ------------------------------------------- |
| `otigo-mark.svg`     | Nur das Logo (Icon), z. B. für kleine Flächen / Favicon |
| `otigo-wordmark.svg` | Logo **mit** Schriftzug „OTIGO Digital" (Navbar & Footer) |

## Ersetzen

- **Bevorzugt SVG** (scharf auf allen Auflösungen). Gleicher Dateiname → fertig.
- **PNG möglich:** Datei als `otigo-mark.png` / `otigo-wordmark.png` ablegen und
